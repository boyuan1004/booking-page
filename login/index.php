	...
	<div id="box">
		<div class="topnav">
			<a class="btn" href="home.php"><i class="fa fa-home"></i></a>
  			<a class="col" href="logout.php">登出</a>
  			<a class="col" href="security.php">更新用戶資料</a>
			<a class="col" href="home.php">訂票</a>
  			<a class="col" href="forget_pw.php">交易歷史紀錄</a>
		</div>
		<form>
			<h2  style="margin: 10px;color: white;">您好 <?php echo $user_data['cus_Lname']; ?><?php echo $user_data['cus_Fname'];?> 歡迎登入此系統</h2>
